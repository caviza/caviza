...
/**
 * Application's main component. This is the parent of all the components in the current application. None contains this
 * one, and it contains all. This is the base from which top level aspects are configured, such as theming, top level
 * routing, etc.
 */
