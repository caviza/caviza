...
/**
 * This component is the Header displayed at the top of the application, once the user logs in. It contains the app
 * icon, search box, notifications and other elements that should always be present in every section of the app.
 */
class Header extends React.Component {
    ...
    render() {
        ...
        const isHorizontalAndBelowHeader = navigationStyle === HORIZONTAL_NAVIGATION
            && horizontalNavPosition === BELOW_THE_HEADER;
        const navigationStyleRule = (isHorizontalAndBelowHeader) ? 'app-main-header-top' : '';

        return (
            <AppBar
                className={`app-main-header ${navigationStyleRule}`}>
